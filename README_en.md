...
- **3D pose** — Place a VRM/GLB/GLTF model inside a panel, pose it, and bake it into the image. Supports a draggable LookAt target, spring bone (hair/skirt) physics, and a breeze wind effect with a draggable wind-direction marker. Sliders to the left of "Place in Panel" adjust the camera's **FOV (10–120°) and Near clip plane (0.01–5)** (via [comfyui-vrm-pose-editor](#optional-dependencies))
