...
- **I2I 連携** — 選択画像（I2I）または現在のページ全体を PNG 化したもの（PI2I）を Workflow Studio の Generate UI へ送信し、生成結果を呼び戻せる。設定タブでデフォルトワークフローの自動読み込みも指定可能（[ComfyUI-Workflow-Studio](#依存関係任意) 連携）
