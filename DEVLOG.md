...
## 2026-09-25（フキダシ表示/非表示の誤保存バグ修正・オートレイアウト×テンプレート連携・レイヤーパネルAlt+クリック一括切替、未リリース）
...
## 2026-09-25（Autoタブの多言語対応バグ修正・LLM出力の頑健パース強化・レイアウトGenerate連携、未リリース）
...
**未対応**: README（3言語）・ヘルプは本件すべて反映済み。バージョン更新・リリースは未実施。

---

## 2026-09-24（オートレイアウトサブタブの改善8件・ヘルプ反映、未リリース）
...
**未対応**: README（3言語）は未反映（ユーザー確認後に反映する既定の運用フロー）。バージョン更新・リリースは未実施。

---

## 2026-09-22（Autoタブ「オートレイアウト」サブタブを追加、フキダシに「キャプション」種別を追加、未リリース）
