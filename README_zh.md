...
- **输出** — 导出为 JPEG/PNG/WebP/PDF/EPUB 格式，支持多页面批量导出与自动编号文件名

### 排版标签
- **图像放置** — 拖放图像到分格中，通过手柄调整大小和旋转
- **对话气泡** — 在分格内放置椭圆、圆角矩形、思考、爆炸等形状的对话气泡，支持8点调整手柄
- **文字** — 支持横排/竖排，Google Fonts / 系统字体，可设置填充、描边、勾边字、阴影的样式弹窗
