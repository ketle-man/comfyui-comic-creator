...
- **对话气泡** — 在分格内放置椭圆、圆角矩形、思考、爆炸、云朵（蓬松/波浪）等形状的对话气泡，支持8点调整手柄。**无尾巴**复选框可将尾巴长度设为0并隐藏（取消勾选会恢复为之前的长度）。**内嵌文字**按钮可为以上任意形状内嵌自动换行的文字（支持竖排、文字颜色、独立于文字对齐的上下/左右位置调整、Google/系统/分类字体选择，双击已内嵌文字的气泡可重新编辑）。素材中的自定义SVG气泡放置后也可修改填充色・边框色
